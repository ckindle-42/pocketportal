...
class AgentCoreV2:
    ...
    async def process_message(
        ...
        with TraceContext() as trace_id:
            try:
                ...
                # Step 2: Build system prompt from templates
                ...
                # Step 4: Route and execute with LLM
                ...
                # Step 5: Save context (user message + assistant response)
                await self._save_context(chat_id, message, result.content, interface)
    ...
    async def _save_context(self, chat_id: str, user_message: str, assistant_response: str, interface: str):
        ...
        logger.debug("Context saved", chat_id=chat_id)
