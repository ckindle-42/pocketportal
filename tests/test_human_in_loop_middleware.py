...
from pocketportal.middleware import (
    ToolConfirmationMiddleware,
    ConfirmationRequest,
    ConfirmationStatus
)
from pocketportal.core.event_bus import EventBus, EventType
...
class TestIntegrationWithAgentCore:
    ...
    async def test_tool_execution_with_confirmation(self):
        ...
        from pocketportal.core import create_agent_core, EventBus
    ...
    async def test_tool_execution_denied(self):
        ...
        from pocketportal.core.exceptions import ToolExecutionError
