...
from pocketportal.tools.document_processing.document_metadata_extractor import DocumentMetadataExtractorTool
from pocketportal.tools.document_processing.excel_processor import ExcelProcessorTool
from pocketportal.tools.document_processing.pandoc_converter import PandocConverterTool
from pocketportal.tools.document_processing.powerpoint_processor import PowerPointProcessorTool
from pocketportal.tools.document_processing.word_processor import WordProcessorTool
from pocketportal.tools.document_tools.pdf_ocr import PDFOCRTool
...
class TestDocumentMetadataExtractorTool:
    ...
    async def test_extract_metadata(self, temp_dir):
        ...
        with patch("pocketportal.tools.document_processing.document_metadata_extractor.PyPDF2"):
