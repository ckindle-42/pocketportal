...
from pocketportal.tools.system_tools.clipboard_manager import ClipboardManagerTool
from pocketportal.tools.system_tools.process_monitor import ProcessMonitorTool
from pocketportal.tools.system_tools.system_stats import SystemStatsTool
