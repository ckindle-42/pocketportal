...
from pocketportal.tools.web_tools.http_client import HTTPClientTool
from pocketportal.tools.media_tools.audio.audio_transcriber import AudioTranscribeTool
...
class TestDevTools:
    ...
    async def test_python_env_manager(self, temp_dir):
        ...
        from pocketportal.tools.dev_tools.python_env_manager import PythonEnvManagerTool
