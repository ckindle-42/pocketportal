...
from pocketportal.observability.config_watcher import ConfigWatcher
...
async def test_observability_imports():
    ...
    try:
        ...
        try:
            from pocketportal.observability import setup_telemetry
            print("  ✓ Can import setup_telemetry")
        except ImportError as e:
            print(f"  ⚠️  Tracer import warning: {e}")

        try:
            from pocketportal.observability import MetricsCollector
