...
class TestCLICommands:
    ...
    def run_cli(self, *args):
        ...
        cmd = [sys.executable, "-m", "pocketportal"] + list(args)
    ...
    def test_cli_help(self):
        ...
        assert "pocketportal" in result.stdout.lower() or "usage" in result.stdout.lower(), \
    ...
    def test_cli_version(self):
        ...
        assert "4.7.4" in result.stdout or "pocketportal" in result.stdout.lower(), \
    ...
    def test_version_command(self):
        ...
        assert "pocketportal" in result.stdout.lower() or "4.7" in result.stdout, \
