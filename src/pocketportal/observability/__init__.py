...
Production-grade observability for PocketPortal.
...
--------------
# Setup tracing
from pocketportal.observability import setup_telemetry, instrument_fastapi
setup_telemetry(service_name="pocketportal")
instrument_fastapi(app)

# Setup health checks
from pocketportal.observability import HealthCheckSystem, register_health_endpoints
health = HealthCheckSystem()
health.add_provider("database", database_health_check)
register_health_endpoints(app, health)

# Setup metrics
from pocketportal.observability import MetricsCollector, register_metrics_endpoint
metrics = MetricsCollector()
register_metrics_endpoint(app, metrics)

# Setup config watching
from pocketportal.observability import watch_config
