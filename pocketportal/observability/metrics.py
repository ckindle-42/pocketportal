...
class MetricsCollector:
    """
    Prometheus metrics collector for PocketPortal.

    Provides common metrics out of the box and allows
    custom metric registration.
    """

    def __init__(self, service_name: str = "pocketportal"):
        """
    ...
    def _init_standard_metrics(self):
        ...
        self._metrics['http_requests_total'] = Counter(
            'pocketportal_http_requests_total',
            'Total HTTP requests',
            ['method', 'endpoint', 'status']
        )

        self._metrics['http_request_duration_seconds'] = Histogram(
            'pocketportal_http_request_duration_seconds',
